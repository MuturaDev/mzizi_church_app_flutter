...
class HomeRecentPledgeContributions extends StatelessWidget {
  const HomeRecentPledgeContributions({Key key}) : super(key: key);
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text("Recent Pledges & Contributions",
                        style:
                            TextStyle(color: Color(0xFF487890), fontSize: 15))
                  ],
                ),
                SpringButton(
          ...
          Container(
              ...
              child: EnhancedFutureBuilder(
                  ...
                  whenDone: (dynamic data) {
                    List<PortalRecentTransaction> portalRecentTransactionList =
                        data;
                    return recentPledgesAndContributionsListViewItemWidget(
