...
passwordTextEditorController = new TextEditingController();
  ...
  TextEditingController getChurchCodeController(){
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _emailPasswordWidget() {
    return Column(
      children: <Widget>[
        _entryField("Username", getUsernameController()),
        _entryField("Password",getPasswordController(), isPassword: true),
        _entryField("Church Code", getChurchCodeController()),
      ],
    );
  }
