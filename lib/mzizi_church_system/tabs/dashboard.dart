...
class Dashboard extends KFDrawerContent {
  ...
  Dashboard({this.onMenuPressedHere, Key key});
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Container(
                      ...
                      child: Image.network("https://imagizer.imageshack.com/img924/1260/o8aVXk.jpg", fit: BoxFit.fill,
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return (index % 2) == 0
                            ...
                            : dashboardBottomListViewItemWidget(
                                new CommunicationModel(Icons.date_range,
                                    "Annoucements", ['for', "THIS WEEK"]));
                      },
                    ),
                  ),
                  Container(
